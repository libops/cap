...
func TestLoadFromEnv_MissingGCPVars(t *testing.T) {
	resetEnv()
	// Intentionally omit GCP_PROJECT_ID
	...
	expectedError := "GCP environment variables (GCP_PROJECT_ID, GCP_ZONE, GCP_INSTANCE_NAME) must be set"
